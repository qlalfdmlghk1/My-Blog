...
export function TagChip({
  ...
  const className = [
    ...
    // 높이가 고정이라 줄바꿈을 막는다 — 좁은 폭에서 긴 이름이 두 줄로 꺾이면 칩 밖으로 넘친다.
    'inline-flex h-6 items-center whitespace-nowrap rounded-full px-2.5 text-xs leading-none transition-colors',
